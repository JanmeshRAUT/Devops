  ...
  const renderAddModal = () => (
    <div className="modal-overlay" onClick={() => setViewMode("list")}>
      ...
      >
        ...
        <div className="modal-body registration-modal">
        <form onSubmit={handleRegisterUser} className="user-reg-form">
          
          {/* BASIC INFORMATION SECTION */}
          <div className="user-reg-section">
            <h4 className="user-reg-title">Basic Information</h4>
            
            <div className="user-reg-row">
              <div className="user-reg-col">
                <label>Full Name *</label>
                <div className="user-reg-field">
                  <FaUser className="user-reg-icon" />
                  <input
                    type="text"
              ...
              <div className="user-reg-col">
                ...
                <div className="user-reg-field">
                  <FaEnvelope className="user-reg-icon" />
                  <input
                    type="email"
            ...
            <div className="user-reg-row">
              <div className="user-reg-col">
                ...
                <div className="user-reg-field">
                  <FaIdCard className="user-reg-icon" />
                  <select
                    value={newUser.role}
                    onChange={(e) =>
              ...
              <div className="user-reg-col">
                <label>Gender *</label>
                <div className="user-reg-field">
                  <FaVenusMars className="user-reg-icon" />
                  <select
          ...
          {/* PATIENT INFORMATION SECTION - CONDITIONAL */}
          {newUser.role === "patient" && (
            <div className="user-reg-section">
              <h4 className="user-reg-title">Patient Information</h4>
              
              <div className="user-reg-row">
                <div className="user-reg-col">
                  <label>Date of Birth</label>
                  <div className="user-reg-field">
                    <FaBirthdayCake className="user-reg-icon" />
                    <input
                      type="date"
                      value={newUser.dob}
                      onChange={(e) => {
              ...
              <div className="user-reg-row">
                ...
                <div className="form-grid-col">
                  ...
                  <div className="form-input-box">
                    <FaCheckCircle className="form-input-icon" />
                    <input
                      type="text"
